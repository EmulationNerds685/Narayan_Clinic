        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
          <div className="md:flex">
            <div className="md:w-1/3 p-6 flex justify-center">
              <div className="relative w-48 h-48 rounded-full overflow-hidden border-4 border-red-100">
            ...
            <div className="md:w-2/3 !p-6">
              ...
              <p className="text-lg text-red-600 font-medium !mb-4">{sushant.specialty}</p>
          ...
          <div className="!px-6 !py-4 bg-gray-50 border-t border-gray-100">
            <Link to={sushant.link}>
              <button className="w-full bg-red-600 hover:bg-red-700 text-white !py-2 !px-4 rounded-lg transition-colors duration-300">
                Book Appointment
              </button>
            </Link>
          </div>
