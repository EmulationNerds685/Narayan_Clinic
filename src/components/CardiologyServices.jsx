...
import {
  ...
  FaProcedures, FaAppleAlt, FaPlug, FaHospitalAlt, FaCalendarCheck,
  FaUserMd, FaAward, FaBriefcase,
} from 'react-icons/fa';
...
const cardiologyServices = [
  ...
  { title: 'Heart Disease Risk Assessment', description: 'Evaluates your risk of developing heart disease.', icon: <FaClipboardCheck /> },
  {
    ...
    description: 'Angioplasty, pacemaker, TAVI, EVAR, electrophysiology, and more.',
    icon: <FaProcedures />,
  },
...
const doctor = {
  ...
  experience: ['Senior Consultant, Ford Hospital, Patna', 'Assistant Director, IGIC, PMCH'],
};
